...
function PatientResultsPortal({
  ...
  const email = initialEmail || "patient@example.com"
  ...
  const filteredResults = React.useMemo(() => {
    ...
    return releasedResults.filter((result) =>
      [result.id, result.examination, result.dateReleased].some((value) =>
  ...
  function handleSignOut() {
    ...
    router.push("/online-results/patient")
  }
          ...
          <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="relative w-full sm:w-80">
              ...
              <Input
                ...
                aria-label="Search patient results"
              />
            </div>
          </div>
            ...
            <CardContent className="px-0">
              <div className="overflow-x-auto">
                <table className="w-full min-w-[760px] border-collapse text-left text-sm">
                  <thead>
                    <tr className="border-b border-slate-100 bg-slate-50 text-xs font-extrabold tracking-wide text-slate-600 uppercase">
                  ...
                  <tbody>
                    {filteredResults.length > 0 ? (
                      ...
                      <tr>
                        ...
                        >
                          No released results match your search.
                        </td>
                      </tr>
                    )}
                  </tbody>
              ...
              <div className="flex flex-col gap-4 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
                <p className="text-sm font-semibold text-slate-500">
                  Showing {filteredResults.length} of {releasedResults.length}{" "}
                  released result
